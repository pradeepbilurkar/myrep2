...
def getLandmarks(im):
    ...
    # imSmall = imutils.resize(im, width=400, height=400)
...
while (validFrames < dummyFrames):
    ...
    if landmarks == 0:
        ...
        cv2.putText(frame, "Caliberation in Progress", (200, 30), cv2.FONT_HERSHEY_COMPLEX, 0.5, (0, 0, 255), 1,
                    cv2.LINE_AA)
        cv2.imshow("Blink Detection Demo", frame)
